...
(async () => {
  ...
  await page.goto('https://8080-bcbcafcdfbebbaacdcbbbadbecafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-bcbcafcdfbebbaacdcbbbadbecafaafdfd.project.examly.io');
